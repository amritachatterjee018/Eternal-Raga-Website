    ...
    <div className="bg-[var(--color-brand-bg)] min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 text-center">
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link to="/mantras" className="secondary-button px-5 py-2.5 rounded-xl text-sm font-semibold">
            Mantras &amp; Stotrams
          </Link>
          <Link to="/scriptures" className="secondary-button px-5 py-2.5 rounded-xl text-sm font-semibold">
            Sacred Scriptures
          </Link>
          <Link to="/meditate" className="secondary-button px-5 py-2.5 rounded-xl text-sm font-semibold">
            Meditate &amp; Yoga
          </Link>
        </div>
      </div>
