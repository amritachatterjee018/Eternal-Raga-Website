...
const TempleCard: React.FC<{ temple: any }> = ({ temple }) => (
  <Link to={`/temples/${temple.name.toLowerCase().replace(/\s+/g, '-')}`} className="interactive-card group rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-white">
