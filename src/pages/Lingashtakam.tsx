      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-24 space-y-8">
            ...
            {/* Deity Card */}
            <Link to="/deities/shiva" className="interactive-card block bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden group">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="#" className="text-gray-700 hover:text-[var(--color-brand-gold-dark)] font-medium flex items-center gap-2 transition-colors">
