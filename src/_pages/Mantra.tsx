          ...
          <div className="sticky top-32 space-y-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="space-y-4">
                <Link href="/mantras/bajrang-baan" className="block group">
                ...
                <Link href="/mantras/sankat-mochan" className="block group">
                ...
                <Link href="/mantras/hanuman-bahuk" className="block group">
