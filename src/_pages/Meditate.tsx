        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {MEDITATION_GUIDES.map((guide, idx) => (
              <Link key={idx} href="#" className="interactive-card bg-white dark:bg-[#1C0A42] rounded-2xl overflow-hidden border border-gray-200 dark:border-[rgba(200,150,46,0.2)] shadow-sm group block">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-8">
            {YOGA_ASANAS.map((asana, idx) => (
              <Link key={idx} href="#" className="interactive-card bg-white dark:bg-[#1C0A42] rounded-xl overflow-hidden border border-gray-200 dark:border-[rgba(200,150,46,0.2)] shadow-sm group">
          ...
          <div className="text-center mb-16">
            <Link href="#" className="inline-flex items-center gap-2 text-[var(--color-brand-purple)] dark:text-[#D4BFFF] font-medium hover:text-[var(--color-brand-gold-dark)] transition-colors">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {PRANAYAMA.map((prana, idx) => (
              <Link key={idx} href="#" className="interactive-card bg-white dark:bg-[#1C0A42] rounded-2xl overflow-hidden border border-gray-200 dark:border-[rgba(200,150,46,0.2)] shadow-sm group flex flex-col sm:flex-row">
